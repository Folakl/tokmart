      ...
      <nav className='flex justify-between bg-[grey] w-full'>
        ...
        <div className='flex-wrap gap-10 font-bold lg:flex md:flex hidden'>
          <Link to='/shoppingcenter'>
            <h3 className='mt-5 cursor-pointer lg:animate-bounce md:animate-pulse'>HOMEPAGE</h3>
          </Link>
          ...
          <Link to='/signup'>
            <button className='w-[120px] mt-3 text-white h-[40px] rounded-md bg-black'>SIGN UP</button>
          </Link>
        </div>
        <div className='lg:hidden md:hidden flex gap-2'>
          ...
          <Link to='/cart'>
            <img src={carticon} className='w-[40px] h-[40px] mt-5' alt="" />
          </Link>
          <Link to='/signup'>
            <button className='w-[80px] mt-5 text-white h-[40px] rounded-md bg-black'>SIGN UP</button>
          </Link>
        </div>
      </nav>
    </div>
