...
const Cart = () => {
  ...
  return (
    <div>
     ...
     <div className="mt-20">
       <h3 className="flex justify-center font-bold text-[30px] my-5">
        Your cart
      </h3>
              ...
              <div>
                ...
                <div className="flex gap-2 my-3">
                  ...
                  <div className="flex lg:w-[120px] md:w-[120px] w-[100px] border-black border-2 rounded-md  gap-5">
                    <button
                      className="w-[40px]  h-full bg-[grey] font-bold"
      ...
      {cart.length > 0 && (
        <div className=" mb-5 justify-self-end mx-10 ">
          <button
            className="bg-[#2c1818] text-white w-[200px] h-[40px] font-bold "
